...
def generate(model, idx, max_new_tokens, context_size, temperature=0.0, top_k=None, eos_id=None):
    ...
    for _ in range(max_new_tokens):
        ...
        # Новое: фильтруем логиты с помощью top_k сэмплирования
        ...
        # В противном случае так же, как и раньше: получаем idx элемента словаря с наибольшим значением логита
        else:
        ...
        # Так же, как и раньше: добавляем выбранный индекс к текущей последовательности
...
def train_model_simple(model, train_loader, val_loader, optimizer, device, num_epochs,
    ...
    # Инициализируем списки для отслеживания потерь и просмотренных токенов
    ...
    for epoch in range(num_epochs):
        ...
        # Выводим образец текста после каждой эпохи
